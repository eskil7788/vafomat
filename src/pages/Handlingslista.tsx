        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="receipt-paper rounded-lg overflow-hidden mb-6">
            ...
            <div className="p-4 min-h-[200px]">
              {items.length === 0 ? (
                <p className="font-receipt text-center text-muted-foreground py-8">
                  Din lista är tom
                </p>
              ) : (
                <ul className="space-y-2">
                  {items.map((item, index) => (
                    <li 
                      key={index}
                      className="font-receipt flex items-center justify-between group"
                    >
            ...
            {items.length > 0 && (
              <div className="border-t-2 border-dashed border-foreground/20 p-4 text-center">
