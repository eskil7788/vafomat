    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="pt-32 pb-20 gradient-hero">
        <div className="container text-center">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '100ms' }}>
          ...
          <Link to="/valj-matratt">
            <Button 
              size="lg" 
              className="text-lg px-8 py-6 animate-fade-in shadow-lg hover:shadow-xl transition-shadow"
